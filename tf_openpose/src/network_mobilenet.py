...
import tf_openpose.src.network_base


class MobilenetNetwork(tf_openpose.src.network_base.BaseNetwork):
    def __init__(self, inputs, trainable=True, conv_width=1.0, conv_width2=None):
        ...
        self.num_refine = 4
        tf_openpose.src.network_base.BaseNetwork.__init__(self, inputs, trainable)
