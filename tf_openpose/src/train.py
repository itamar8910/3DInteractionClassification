...
if __name__ == '__main__':
    ...
    parser.add_argument('--modelpath', type=str, default='/data/private/tf_openpose-models-2018-1/')
    parser.add_argument('--logpath', type=str, default='/data/private/tf_openpose-log-2018-1/')
